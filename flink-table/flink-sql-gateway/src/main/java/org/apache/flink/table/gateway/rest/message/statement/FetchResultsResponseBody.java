...
public class FetchResultsResponseBody implements ResponseBody {
    ...
    public FetchResultsResponseBody(
            @Nullable @JsonProperty(FIELD_RESULTS) ResultSet results,
            @Nullable @JsonProperty(FIELD_RESULT_TYPE) String resultType,
            @Nullable @JsonProperty(FIELD_NEXT_RESULT_URI) String nextResultUri,
            @Nullable @JsonProperty(FIELD_EXCEPTION) ExceptionInfo exceptionInfo) {
