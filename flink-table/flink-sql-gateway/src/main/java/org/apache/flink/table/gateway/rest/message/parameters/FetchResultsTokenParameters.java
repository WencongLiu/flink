...
public class FetchResultsTokenParameters extends MessageParameters {
    ...
    private SessionHandleIdPathParameter sessionHandleIdPathParameter =
            new SessionHandleIdPathParameter();

    private OperationHandleIdPathParameter operationHandleIdPathParameter =
            new OperationHandleIdPathParameter();

    private FetchResultsTokenPathParameter fetchResultsTokenPathParameter =
