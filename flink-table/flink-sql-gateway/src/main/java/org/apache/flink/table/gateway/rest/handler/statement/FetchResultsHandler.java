...
public class FetchResultsHandler
    ...
    protected CompletableFuture<FetchResultsResponseBody> handleRequest(
        ...
        @Nullable Integer maxFetchSize = request.getRequestBody().getMaxFetchSize();
        ...
        @Nullable Throwable fetchResultsException = null;
        @Nullable ResultSet resultSet = null;
        @Nullable String resultType = null;
        @Nullable ExceptionInfo exceptionInfo = null;
        Long nextToken = 0L;
        try {
        ...
        if (fetchResultsException != null) {
            while (fetchResultsException.getCause() != null
                    && fetchResultsException.getCause().getMessage() != null
                    && !fetchResultsException.getCause().getMessage().isEmpty()) {
                fetchResultsException = fetchResultsException.getCause();
            }
            exceptionInfo =
                    new ExceptionInfo(
                            fetchResultsException.getClass().getName(),
