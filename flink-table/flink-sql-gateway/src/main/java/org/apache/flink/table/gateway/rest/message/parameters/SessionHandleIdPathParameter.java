...
public class SessionHandleIdPathParameter extends MessagePathParameter<SessionHandle> {
    ...
    @Override
    protected SessionHandle convertFromString(String sessionHandleId) throws ConversionException {
        return ParseTools.parseStringToSessinHandler(sessionHandleId);
    }

    @Override
    protected String convertToString(SessionHandle sessionHandle) {
        return sessionHandle.getIdentifier().getFullID();
    }
