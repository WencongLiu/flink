...
public class OpenSessionHandler
    ...
    protected CompletableFuture<OpenSessionResponseBody> handleRequest(
            SqlGatewayRestAPIVersion version, @Nonnull HandlerRequest<OpenSessionRequestBody> request) {
        ...
        SessionHandle sessionHandle =
                service.openSession(
                        SessionEnvironment.newBuilder()
                                ...
                                .addSessionConfig(request.getRequestBody().getProperties())
                                .build());

        return CompletableFuture.completedFuture(
                new OpenSessionResponseBody(sessionHandle.getIdentifier().getFullID()));
    }
}
