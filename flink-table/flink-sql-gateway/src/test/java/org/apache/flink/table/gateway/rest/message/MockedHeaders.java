...
public class MockedHeaders
    ...
    private static final MockedHeaders INSTANCE = new MockedHeaders();
    ...
    @Override
    public Class<MockedResponseBody> getResponseClass() {
        return MockedResponseBody.class;
    }
    ...
    @Override
    public Class<MockedRequestBody> getRequestClass() {
        return MockedRequestBody.class;
    }
    ...
    public static MockedHeaders getInstance() {
        return INSTANCE;
    }
