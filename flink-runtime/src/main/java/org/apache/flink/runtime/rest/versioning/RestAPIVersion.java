...
public interface RestAPIVersion<T extends RestAPIVersion<T>> extends Comparator<T> {
    /**
     ...
     */
    static <E extends RestAPIVersion<E>> E getLatestVersion(
            Collection<E> versions, Comparator<E> comparator) {
        return Collections.max(versions, comparator);
    }
}
