...
public class StreamSortPartitionTuple2Test {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple2<String, Integer>> sortResult =
                mapStream.fullWindowPartition().sortPartition("1", Order.ASCENDING);
        sortResult
                .fullWindowPartition()
                .mapPartition(
    ...
    static class OneThousandSource implements Iterator<String>, Serializable {
        ...
        public OneThousandSource() {
            for (int index = 0; index < TOTAL_NUMBER; ++index) {
                allElements.add(new Random().nextInt(TOTAL_NUMBER));
            }
        }
