...
public class KeyedPartitionWindowedStreamITCase extends PartitionWindowedStreamITCaseBase {
    ...
    public void testMapPartition() throws Exception {
        ...
        CloseableIterator<String> resultIterator =
                source.map(
                        ...
                        .executeAndCollect();
        expectInAnyOrder(resultIterator, "k1Testk1Test", "k2Testk2Test", "k3Testk3Test");
    }
