...
/**
 * {@link KeyAndValueSerializer} is used in {@link SortPartitionOperator} for serializing elements
 * including key and record. It serializes the record in a format known by the {@link
