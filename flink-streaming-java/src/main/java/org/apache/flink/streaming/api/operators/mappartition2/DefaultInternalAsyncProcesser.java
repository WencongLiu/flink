...
package org.apache.flink.streaming.api.operators.mappartition2;
...
/** The default implementation of {@link InternalAsyncProcesser}. */
public class DefaultInternalAsyncProcesser<T>
        implements InternalAsyncProcesser<T>, Iterable<T>, Iterator<T> {
    ...
    private final ScheduledExecutorService asyncExecutor =
            Executors.newScheduledThreadPool(
                    1, new ExecutorThreadFactory("InternalAsyncProcesser"));
