...
class SortPartitionOperatorTest {
    ...
    void testSetup() {
        ...
        TestRecordValueAndWatermarkOutput<Tuple2<Integer, String>> tupleOutput =
        ...
        TestRecordValueAndWatermarkOutput<TestPojo> pojoOutput =
                new TestRecordValueAndWatermarkOutput<>();
    ...
    void testProcessElementAndWatermark() throws Exception {
        ...
        List<Watermark> tupleWatermarkList = new ArrayList<>();
        TestRecordValueAndWatermarkOutput<Tuple2<Integer, String>> tupleOutput =
                new TestRecordValueAndWatermarkOutput<>(tupleOutputList, tupleWatermarkList);
        ...
        operator1.processWatermark(testWatermark);
        operator1.endInput();
        ...
        assertThat(tupleWatermarkList.size()).isOne();
        assertEquals(tupleWatermarkList.get(0).getTimestamp(), timestamp);
        // 2.Test SortPartitionOperator sorting record by string field.
        SortPartitionOperator<TestPojo> operator2 = createSortPartitionOperatorWithStringField();
        List<TestPojo> pojoOutputList = new ArrayList<>();
        List<Watermark> pojoWatermarkList = new ArrayList<>();
        TestRecordValueAndWatermarkOutput<TestPojo> pojoOutput =
                new TestRecordValueAndWatermarkOutput<>(pojoOutputList, pojoWatermarkList);
        ...
        operator2.processWatermark(testWatermark);
        operator2.endInput();
        ...
        assertEquals(pojoWatermarkList.get(0).getTimestamp(), timestamp);
        // 3.Test SortPartitionOperator sorting record by key selector.
        SortPartitionOperator<TestPojo> operator3 = createSortPartitionOperatorWithKeySelector();
        List<TestPojo> pojoOutputListForKeySelector = new ArrayList<>();
        List<Watermark> pojoWatermarkListForKeySelector = new ArrayList<>();
        TestRecordValueAndWatermarkOutput<TestPojo> pojoOutputForKeySelector =
                new TestRecordValueAndWatermarkOutput<>(
                        pojoOutputListForKeySelector, pojoWatermarkListForKeySelector);
        ...
        operator3.processWatermark(testWatermark);
        operator3.endInput();
        ...
        assertEquals(pojoWatermarkListForKeySelector.get(0).getTimestamp(), timestamp);
    }
