...
/**
 * Tests for {@link KeyAndValueSerializer} in {@link KeyedSortPartitionOperator}, which verify
 * variable length keys.
 */
class VariableLengthKeyAndValueSerializerTest extends SerializerTestBase<Tuple2<byte[], String>> {
    ...
    protected Class<Tuple2<byte[], String>> getTypeClass() {
        return (Class<Tuple2<byte[], String>>) (Class) Tuple2.class;
    }

    @Override
    protected Tuple2<byte[], String>[] getTestData() {
