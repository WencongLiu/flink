...
/** Unit test for {@link InternalAsyncIterator}. */
class InternalAsyncIteratorTest {

    @Test
    void testRegisterUDF() throws ExecutionException, InterruptedException {
        InternalAsyncIterator<String> iterator = createInternalAsyncIterator();
    ...
    void testClose() throws ExecutionException, InterruptedException {
        ...
        assertThatThrownBy(() -> iterator.registerUDF(ignored -> {}))
                .isInstanceOf(IllegalStateException.class);
    }

    private InternalAsyncIterator<String> createInternalAsyncIterator() {
        return new InternalAsyncIteratorImpl<>();
    }
}
